...
export const NHSAlignmentSection = () => {
  ...
  return (
    <section id="nhs-alignment" className="relative overflow-hidden" style={{ backgroundColor: '#F6F5F3', paddingTop: 'var(--section-top-padding)', paddingBottom: 'var(--space-section)' }}>
